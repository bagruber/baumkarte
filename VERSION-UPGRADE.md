...
Vite 6 -> 8 ist der letzte offene Punkt hier. anagram und learnfarsi laufen bereits auf Vite 8 mit demselben React-19-Stack — das Risiko ist damit belegt niedrig. Nutzt `maplibre-gl` und `moosburg-design` (GitHub-Dependency) — beide nicht anfassen.
